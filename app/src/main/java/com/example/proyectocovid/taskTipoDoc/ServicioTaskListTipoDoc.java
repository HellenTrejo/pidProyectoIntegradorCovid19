package com.example.proyectocovid.taskTipoDoc;
...
public class ServicioTaskListTipoDoc extends AsyncTask<Void, Void, String> {
    //variables del hilo
    private Context httpContext;//contexto
    private String linkURL;
    //constructor del hilo (Asynctask)
    public ServicioTaskListTipoDoc(Context ctx, String linkURL){
